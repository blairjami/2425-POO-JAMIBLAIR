...
def mostrar_menu():
    ...
    unidades = {
        '1': 'Semana 2/ejemplos-poo.py',
        '2': 'Semana 3/poo.py',
        '3': 'EjemplosMundoReal_POO/sistema_reservas.py',
        '4': 'Semana 5/programaarea.py',
        '5': 'Semana 6/s6.py',
        '6': 'Semana 7/s7.py',
    }
...
def mostrar_sub_menu(ruta_unidad):
    # Verifica si la unidad es un archivo o un directorio
    if os.path.isfile(ruta_unidad):  # Si es un archivo, lo mostramos y ejecutamos
        mostrar_scripts(os.path.dirname(ruta_unidad))  # Muestra los scripts del directorio
        return
